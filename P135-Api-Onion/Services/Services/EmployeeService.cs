    ...
    public class EmployeeService : IEmployeeService
    {
        ...
        public async Task<IEnumerable<EmployeeDto>> Search(string searchText)
        {
            IEnumerable<Employee> query = _context.Employees;
                ...
                return  _mapper.Map<IEnumerable<EmployeeDto>>(await _employeeRepo.SearchAsync(searchText));
        ...
        //public async Task<IEnumerable<EmployeeDto>> Search(string fullName)
        //{
        //    IQueryable<EmployeeDto> query = _context.Employees;
